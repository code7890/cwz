          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200 hover:shadow-md transition-shadow">
            ...
            <div className="w-full bg-neutral-200 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(studentData.xp / studentData.nextLevelXp) * 100}%`,
                }}
              ></div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-full">
                {Math.round(
                  (studentData.weeklyProgress / studentData.weeklyGoal) * 100,
                )}
                %
              </span>
            </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center space-x-2">
                        <span
                          className={`text-xs font-medium ${course.accentColor} bg-white px-2 py-1 rounded-full`}
                        >
                          {course.difficulty}
                        </span>
                        <Link
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-neutral-600">
                      You're 70% towards your weekly goal
                    </p>
                  </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        <div
                          className={`w-8 h-8 bg-white rounded-lg flex items-center justify-center flex-shrink-0`}
                        >
                          <Icon
                ...
                {upcomingEvents.map((event) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <span
                        className={`text-xs font-medium ${event.accentColor} bg-white px-2 py-1 rounded-full`}
                      >
                        {event.type}
                      </span>
                    </div>
