...
const CommunityPage: React.FC = () => {
  ...
  const discussions = [
    {
      ...
      content:
        "I'm struggling with using async/await inside useEffect. Getting some weird behavior with my API calls. Can someone help?",
      author: {
        name: "Ahmed Khan",
        avatar:
    ...
    },
    {
      ...
      content:
        "After 3 months of learning, I finally completed my first major project. Used React, Node.js, and MongoDB. Would love feedback!",
      author: {
        name: "Fatima Ali",
        avatar:
    ...
    },
    {
      ...
      content:
        "Started freelancing 6 months ago and now earning $1000+/month. Here are some tips that helped me get started...",
      author: {
        name: "Hassan Sheikh",
        avatar:
    ...
    },
    {
      ...
      content:
        "Looking for recommendations on VS Code extensions that can boost productivity for web development. What are your favorites?",
      author: {
        name: "Sara Khan",
        avatar:
          "https://images.pexels.com/photos/3763152/pexels-photo-3763152.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop",
        level: 10,
        badge: "Developer",
        reputation: 650,
      },
    ...
    },
    {
      ...
      content:
        "Let's discuss this week's coding challenge! Share your approaches and solutions here.",
      author: {
  ...
  const successStories = [
    {
      ...
      story:
        "Started with no coding experience. After 8 months of consistent learning on CodeWithZee, landed my first job as a Full Stack Developer at a tech startup.",
    ...
    },
    {
      ...
      story:
        "Learned web development while managing household. Now earning more than my husband through freelancing projects.",
    ...
    },
    {
      ...
      story:
        "Was working in a textile factory. Learned Python and Data Science. Now working as a Data Analyst at a multinational company.",
  ...
  const DiscussionCard = ({ discussion }: { discussion: any }) => (
    <div
      className={`${discussion.bgColor} ${discussion.borderColor} border-2 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 group`}
    >
      {/* Header */}
  ...
  const SuccessStoryCard = ({ story }: { story: any }) => (
    <div
      className={`${story.bgColor} ${story.borderColor} border-2 rounded-2xl p-6 hover:shadow-lg transition-all duration-300`}
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-neutral-600 max-w-2xl mx-auto">
            Join thousands of learners sharing knowledge, solving problems, and
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          {communityStats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200 text-center"
              >
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3 bg-neutral-50`}
                >
            ...
            {activeTab === "contributors" && (
              <div className="space-y-4">
                {topContributors.map((contributor, index) => (
                  <div
                    key={contributor.id}
                    className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200 hover:shadow-lg transition-shadow"
                  >
